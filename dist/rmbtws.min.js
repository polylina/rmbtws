 ...
 *****************************************************************************!*/
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function RMBTTest(e,t){function n(e){void 0!==M&&M===e||(M=e,E=nowMs(),N&&N(e))}function s(e,t,s){var i=(e.test_server_encryption?"wss://":"ws://")+e.test_server_address+":"+e.test_server_port;p.debug(i);var d=function(){return{IGNORE:function(){},CALLGLOBALHANDLER:function(e){e&&p.error("connection closed",e),G(RMBTError.CONNECT_FAILED)},TRYRECONNECT:function(){G(RMBTError.CONNECT_FAILED)}}}();t.onStateEnter(TestState.INIT_DOWN,function(){n(TestState.INIT_DOWN),p.debug(t.id+": start short download"),m=_,a(t,b.pretestDurationMs)}),t.onStateEnter(TestState.PING,function(){n(TestState.PING),p.debug(t.id+": starting ping"),0===t.id?u(t):t.triggerNextState()}),t.onStateEnter(TestState.DOWN,function(){if(n(TestState.DOWN),A.length>0){var s=r(A,b.downloadThreadsLimitsMbit,!1);L=s.numThreads,I&&(m=s.chunkSize),A=[]}t.id<L?c(t,e.test_duration):t.triggerNextState()}),t.onStateEnter(TestState.INIT_UP,function(){n(TestState.INIT_UP),m=_,l(t,b.pretestDurationMs)}),t.onStateEnter(TestState.UP,function(){if(n(TestState.UP),A.length>0){var s=r(A,b.uploadThreadsLimitsMbit,!0);D=s.numThreads,I&&(m=s.chunkSize),A=[]}t.id<D?f(t,e.test_duration):(t.socket.onerror=d.IGNORE,t.socket.onclose=d.IGNORE,t.socket.readyState!==WebSocket.CLOSED&&t.socket.close(),t.triggerNextState())}),t.onStateEnter(TestState.END,function(){t.socket.readyState!==WebSocket.CLOSED&&t.socket.close(),0===t.id&&s()}),t.setState(TestState.INIT),n(TestState.INIT),o(t,i,e.test_token,d.CALLGLOBALHANDLER)}function o(e,t,n,s){try{e.socket=new WebSocket(t)}catch(e){return void G(RMBTError.SOCKET_INIT_FAILED)}e.socket.binaryType="arraybuffer",e.socket.onerror=s,e.socket.onclose=s,e.socket.onmessage=function(t){if(0===t.data.indexOf("CHUNKSIZE")){var o=t.data.trim().split(" ");4===o.length?(h=parseInt(o[1]),_=parseInt(o[2]),v=parseInt(o[3])):(h=parseInt(o[1]),_=h),p.debug(e.id+": Chunksizes: min "+_+", max: "+v+", default: "+h)}else if(0===t.data.indexOf("RMBTv")){var r=t.data.substring(5).trim();b.client_version=r,0===r.indexOf("1.")?I=!0:0===r.indexOf("0.3")?I=!1:p.warn("unknown server version: "+r)}else"ACCEPT TOKEN QUIT\n"===t.data?e.socket.send("TOKEN "+n+"\n"):"OK\n"===t.data&&e.state===TestState.INIT?p.debug(e.id+": Token accepted"):"ERR\n"===t.data?(s(),p.error("got error msg")):0===t.data.indexOf("ACCEPT GETCHUNKS")&&e.triggerNextState()}}function r(e,t,n){x=e.reduce(function(e,t){return e+t}),p.debug("total: circa "+x/1e3+" KB/sec"),p.debug("total: circa "+8*x/1e6+" MBit/sec");var s=8*x/1e6,o=0;Object.keys(t).forEach(function(e){s>e&&(o=t[e])}),o=Math.min(B,o),p.debug("set number of threads to be used in upcoming speed test to: "+o);var r=x/(1e3/(b.measurementPointsTimespan/2));if(r-=r%1024,r=Math.max(_,r),r=Math.min(v,r),p.debug("calculated chunksize for upcoming speed test "+r/1024+" KB"),n){var a=Number.POSITIVE_INFINITY;Object.keys(R).forEach(function(e){Math.abs(r-e)<Math.abs(r-a)?("string"==typeof e&&(e=parseInt(e)),a=e):(delete R[e],delete U[e])}),r=a,p.debug("fallback to existing chunksize for upcoming speed test "+r/1024+" KB")}return{numThreads:o,chunkSize:r,bytesPerSecs:x}}function a(e,t){var n=e.socket.onmessage,s=nowMs(),o=1,r=0,a=m;!function u(){i(e,o,a,function(i){r+=o*a,p.debug(e.id+": "+i);var d=parseInt(i.substring(5));nowMs()-s>t?(A.push(o*a/(d/1e9)),e.socket.onmessage=n):o<8||!I?(o*=2,u()):(a=Math.min(2*a,v),u())})}()}function i(e,t,n,s){var o=e.socket,r=t,a=m*t,i=0,u=null,d=function(e,t){var n=new Uint8Array(e.length+t.length);return n.set(e,0),n.set(t,e.length),n},c=function(e){if("string"!=typeof e.data){var t=!1;u=null===u?new Uint8Array(e.data):d(u,new Uint8Array(e.data)),i+=e.data.byteLength,u.length===n&&(r--,t=!0),t&&255===u[u.length-1]?(o.onmessage=function(e){var t=e.data;s(t)},o.send("OK\n"),U[n]=u.buffer,u=null):(R.hasOwnProperty(n)||(R[n]=[]),t&&(R[n].length<b.savedChunks&&R[n].push(u.buffer),u=null))}};o.onmessage=c,p.debug(e.id+": downloading "+t+" chunks, "+a/1e3+" KB");var l="GETCHUNKS "+t+(n!==h?" "+n:"")+"\n";o.send(l)}function u(e){var t=e.socket.onmessage,n=b.numPings;d(e,function s(o){if(e.result.pings.push(o),n===b.numPings-1&&(O.durationPingMs=(e.result.pings[1].timeNs-e.result.pings[0].timeNs)/1e6*b.numPings,p.debug(e.id+": PING phase will take approx "+O.durationPingMs+" ms")),p.debug(e.id+": PING "+o.client+" ns client; "+o.server+" ns server"),--n>0)e.socket.onmessage=function(t){"ACCEPT GETCHUNKS GETTIME PUT PUTNORESULT PING QUIT\n"===t.data?d(e,s):p.error("unexpected error during ping test")};else{for(var r=[],a=0;a<e.result.pings.length;a++)r.push(e.result.pings[a].client);S.ping_client_median=Math.median(r),S.ping_client_shortest=Math.min.apply(Math,r);for(var i=[],u=0;u<e.result.pings.length;u++)i.push(e.result.pings[u].server);S.ping_server_median=Math.median(i),S.ping_server_shortest=Math.min.apply(Math,i),p.debug(e.id+": median client: "+Math.round(S.ping_client_median/1e3)/1e3+" ms; median server: "+Math.round(S.ping_server_median/1e3)/1e3+" ms"),p.debug(e.id+": shortest client: "+Math.round(S.ping_client_shortest/1e3)/1e3+" ms; shortest server: "+Math.round(S.ping_server_shortest/1e3)/1e3+" ms"),e.socket.onmessage=t}})}function d(e,t){var n=void 0,s=void 0,o=function(o){if("PONG\n"===o.data){var r=nowNs();s=r-n,e.socket.send("OK\n")}else if(0===o.data.indexOf("TIME")){var a=new RMBTPingResult;a.client=s,a.server=parseInt(o.data.substring(5)),a.timeNs=n,t(a)}};e.socket.onmessage=o,n=nowNs(),e.socket.send("PING\n")}function c(e,t){var n=e.socket.onmessage,s=0,o=0,r=-1,a=void 0,i=void 0,u=null,d=null;a=window.setInterval(function(){if(null!==u&&r!==o){r=o;var t=nowNs();p.debug(e.id+": "+i+"|"+b.measurementPointsTimespan+"|"+t+"|"+o);var c=new Uint8Array(u,u.byteLength-1,1),g=d-l;e.result.down.push({duration:g,bytes:s}),i=t,c[0]>=255&&(p.debug(e.id+": received end chunk"),window.clearInterval(a),e.socket.onmessage=function(t){p.debug(t.data),e.socket.onmessage=n},e.socket.send("OK\n"))}},b.measurementPointsTimespan);var c=function(e){o++,s+=e.data.byteLength,d=nowNs(),u=e.data};e.socket.onmessage=c;var l=nowNs();e.socket.send("GETTIME "+t+(m!==h?" "+m:"")+"\n")}function l(e,t){var n=e.socket.onmessage,s=nowMs(),o=1,r=0,a=m;window.setTimeout(function(){var e=nowMs(),n=e-s;p.debug("diff:"+(n-t)+" ("+(n-t)/t+" %)")},t);!function i(){g(e,o,a,function(u){if(r+=o*a,p.debug(e.id+": "+u),nowMs()-s>t){e.socket.onmessage=n;var d=parseInt(u.substring(5));A.push(o*a/(d/1e9))}else{var c=2*a;o<8||!U.hasOwnProperty(c)||!I?(o*=2,i()):(a=Math.min(2*a,v),i())}})}()}function g(e,t,n,s){var o=e.socket;o.onmessage=function(e){0!==e.data.indexOf("OK")&&0!==e.data.indexOf("ACCEPT")&&s(e.data)},p.debug(e.id+": uploading "+t+" chunks, "+n*t/1e3+" KB"),o.send("PUTNORESULT"+(I?" "+n:"")+"\n");for(var r=0;r<t;r++){var a=void 0;a=r===t-1?U[n]:R[n][0],o.send(a)}}function f(e,t){var n=e.socket.onmessage,s=x/2/D,o=1.5*x/D,r=document.hidden?o:s,a=function(){r=document.hidden?o:s,p.debug("document visibility changed to: "+document.hidden)};document.addEventListener("visibilitychange",a);var i=Math.ceil(x/D/m),u=!1,d=!0,c=-1,l=0,g=function s(){u||(p.debug(e.id+": is 7.2 sec in, got data for "+c),c<1e9*t&&l<3e3?(window.setTimeout(s,250),l+=250):(p.debug(e.id+": didn't finish, timeout extended by "+l+" ms, last info for "+c),e.socket.onerror=function(){},e.socket.onclose=function(){},e.socket.close(),e.socket.onmessage=n,p.debug(e.id+": socket now closed: "+e.socket.readyState),document.removeEventListener("visibilitychange",a),e.triggerNextState()))},f=function t(){if(e.socket.bufferedAmount<r)for(var n=0;n<i;n++)e.socket.send(R[m][n%R[m].length]);if(!d)return!1;setTimeout(t,0)};window.setTimeout(g,1e3*t+200),window.setTimeout(function(){d=!1,e.socket.onclose=function(){},e.socket.send(U[m]),e.socket.send("QUIT\n")},1e3*t),p.debug(e.id+": set timeout");var T=1e6*b.measurementPointsTimespan,v=/TIME (\d+) BYTES (\d+)/,_=/TIME (\d+)/,I=function(t){"OK\n"===t.data&&f();var s=v.exec(t.data);if(null!==s){var o={duration:parseInt(s[1]),bytes:parseInt(s[2])};o.duration-c>T&&(c=o.duration,e.result.up.push(o))}else null!==(s=_.exec(t.data))&&(u=!0,p.debug("Upload duration: "+s[1]),e.socket.onmessage=n,document.removeEventListener("visibilitychange",a))};e.socket.onmessage=I,e.socket.send("PUT"+(m!==h?" "+m:"")+"\n")}function T(e){return{client_language:"de",client_name:b.client,client_uuid:b.uuid,client_version:b.client_version,client_software_version:b.client_software_version,geoLocations:S.geoLocations,model:b.model,network_type:98,platform:b.platform,product:b.product,pings:S.pings,test_bytes_download:S.bytes_download,test_bytes_upload:S.bytes_upload,test_nsec_download:S.nsec_download,test_nsec_upload:S.nsec_upload,test_num_threads:L,num_threads_ul:D,test_ping_shortest:S.ping_server_shortest,test_speed_download:S.speed_download,test_speed_upload:S.speed_upload,test_token:e.test_token,test_uuid:e.test_uuid,time:S.beginTime,timezone:b.timezone,type:"DESKTOP",version_code:"1",speed_detail:S.speedItems,user_server_selection:b.userServerSelection,loop_uuid:window.loopFirstTestUUID}}var p=log&&log.getLogger?log.getLogger("rmbtws"):new MockLogger,m=null,v=4194304,_=0,h=4096,I=!1,b=void 0,k=void 0,S=null,w=null,N=null,M=TestState.INIT,E=null,O={durationInitMs:2500,durationPingMs:1e4,durationUpMs:-1,durationDownMs:-1},P=new RMBTIntermediateResult,y=[],R={},U={},C=null,B=0,L=0,D=0,A=[],x=0;this.onError=function(e){w=e},this.onStateChange=function(e){N=e};var G=function(e){if(p.debug("error occurred during websocket test:",e),e!==RMBTError.NOT_SUPPORTED&&n(TestState.ERROR),null!==w){var t=w;w=null,t(e)}};this.startTest=function(e){if(void 0===window.WebSocket)return void G(RMBTError.NOT_SUPPORTED);n(TestState.INIT),S=new RMBTTestResult,k.getDataCollectorInfo(),k.obtainControlServerRegistration(function(t){e||(window.loopFirstTestUUID=t.test_uuid),B=parseInt(t.test_numthreads),C=new CyclicBarrier(B),O.durationDownMs=1e3*t.test_duration,O.durationUpMs=1e3*t.test_duration,null!==TestEnvironment.getTestVisualization()&&TestEnvironment.getTestVisualization().updateInfo(t.test_server_name,t.client_remote_ip,t.provider,t.test_uuid);!function(){p.debug("got geolocation, obtaining token and websocket address");var e=function(){n(TestState.INIT),S.beginTime=Date.now();for(var e=0;e<B;e++){var o=new RMBTTestThread(C);o.id=e,S.addThread(o.result),s(t,o,function(){p.info("All tests finished"),S.calculateAll(),k.submitResults(T(t),function(){n(TestState.END)},function(){G(RMBTError.SUBMIT_FAILED)})}),y.push(o)}};0===t.test_wait?e():(p.info("test scheduled for start in "+t.test_wait+" second(s)"),n(TestState.WAIT),self.setTimeout(function(){e()},1e3*t.test_wait))}()},function(){G(RMBTError.REGISTRATION_FAILED)})},this.getIntermediateResult=function(){P.status=M;var e=nowNs()/1e6-E;switch(P.diffTime=e/1e3,P.status){case TestState.WAIT:P.progress=0;break;case TestState.INIT:case TestState.INIT_DOWN:case TestState.INIT_UP:P.progress=e/O.durationInitMs;break;case TestState.PING:P.progress=e/O.durationPingMs;break;case TestState.DOWN:P.progress=e/O.durationDownMs;break;case TestState.UP:P.progress=e/O.durationUpMs;break;case TestState.END:P.progress=1;break;case TestState.ERROR:case TestState.ABORTED:P.progress=0}if(isNaN(P.progress)&&(P.progress=0),P.progress=Math.min(1,P.progress),null!==S){if(P.status!==TestState.PING&&P.status!==TestState.DOWN||(P.pingNano=S.ping_server_median),P.status===TestState.DOWN||P.status==TestState.INIT_UP){var t=RMBTTestResult.calculateOverallSpeedFromMultipleThreads(S.threads,function(e){return e.down});P.downBitPerSec=t.speed,P.downBitPerSecLog=(Math.log10(P.downBitPerSec/1e6)+2)/4}if(P.status===TestState.UP||P.status==TestState.INIT_UP){var n=RMBTTestResult.calculateOverallSpeedFromMultipleThreads(S.threads,function(e){return e.up});P.upBitPerSec=n.speed,P.upBitPerSecLog=(Math.log10(P.upBitPerSec/1e6)+2)/4}}return P},this.getState=function(){return"INIT"},function(e,t){b=e,k=t}(e,t)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var s=t[n];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(e,s.key,s)}}return function(t,n,s){return n&&e(t.prototype,n),s&&e(t,s),t}}();exports.RMBTTest=RMBTTest;var MockLogger=function(){function e(){_classCallCheck(this,e)}return _createClass(e,[{key:"debug",value:function(){}},{key:"error",value:function(){}},{key:"info",value:function(){}},{key:"warn",value:function(){}},{key:"log",value:function(){}}]),e}();
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var RMBTControlServerCommunication=exports.RMBTControlServerCommunication=function(e,r,t){var o=e,n=log&&log.getLogger?log.getLogger("rmbtws"):new MockLogger;return{obtainControlServerRegistration:function(e,s){var i={version:o.version,language:o.language,uuid:o.uuid,type:o.type,version_code:o.version_code,client:o.client,timezone:o.timezone,time:(new Date).getTime(),measurement_server_id:t?t.id:void 0};Object.assign(i,o.additionalRegistrationParameters),"undefined"!=typeof userServerSelection&&userServerSelection>0&&"undefined"!=typeof UserConf&&void 0!==UserConf.preferredServer&&"default"!==UserConf.preferredServer&&(i.prefer_server=UserConf.preferredServer,i.user_server_selection=userServerSelection),$.ajax({headers:r,url:o.controlServerURL+o.controlServerRegistrationResource,type:"post",dataType:"json",contentType:"application/json",data:JSON.stringify(i),success:function(r){var t=new RMBTControlServerRegistrationResponse(r);e(t)},error:function(){n.error("error getting testID"),s()}})},getDataCollectorInfo:function(){$.ajax({headers:r,url:o.controlServerURL+o.controlServerDataCollectorResource,type:"get",dataType:"json",contentType:"application/json",success:function(e){o.product=e.agent.substring(0,Math.min(150,e.agent.length)),o.model=e.product,o.os_version=e.version},error:function(e){n.error("error getting data collection response")}})},submitResults:function(e,t,s){Object.assign(e,o.additionalSubmissionParameters);var i=JSON.stringify(e);n.debug("Submit size: "+i.length),$.ajax({headers:r,url:o.controlServerURL+o.controlServerResultResource,type:"post",dataType:"json",contentType:"application/json",data:i,success:function(r){n.debug(e.test_uuid),t(!0)},error:function(e){n.error("error submitting results"),s(!1)}})}}};
